...
#/******************************************/
	...
	def description_plot(self, params):
		...
		save(p,"C:\\Users\\Niclas\\Development\\PA2\\Tool_Niclas_23.06.2022 (1)\\processed\\SAP_Test_Data_BKPF Table.txt_processed\picture\description_plot_SAP_Test_Data_BKPF_Table.html")
		return html
	...
	def unique(self, params):
		...
		html = "<center>"+html+"</center>"
		save(p,"C:\\Users\\Niclas\\Development\\PA2\\Tool_Niclas_23.06.2022 (1)\\processed\\SAP_Test_Data_BKPF Table.txt_processed\picture\uniqueSAP_Test_Data_BKPF_Table.html")
		return html
