...
#*** Date:	  23 Oct 2022 13:47:37
#***
#*** Source:	processed\SAP_Test_Data_BKPF_Table_for_automation.txt_processed
#***
...
class SAP_Test_Data_BKPF_Table_for_automation(server.App): 
	link = "C:\\Users\\Niclas\\Development\\PA2\\Tool_Niclas_23.06.2022 (1)\\processed\\SAP_Test_Data_BKPF_Table_for_automation.txt_processed"
...
#/******************************************/
	...
	def datahead(self,params):
		df = of.Data(SAP_Test_Data_BKPF_Table_for_automation.link)
		return df.head(10)

	def description(self, params):
		value = params["values"]
		df = of.overview(SAP_Test_Data_BKPF_Table_for_automation.link,True)
	...
	def description_plot(self, params):
		...
		save(p,"C:\\Users\\Niclas\\Development\\PA2\\Tool_Niclas_23.06.2022 (1)\\processed\\SAP_Test_Data_BKPF_Table_for_automation.txt_processed\picture\description_plot_SAP_Test_Data_BKPF_Table_for_automation.html")
		return html

	def unique(self, params):
		value = params["values"]
		test=copy.copy(value)
		df_string = of.data_str(SAP_Test_Data_BKPF_Table_for_automation.link)
		...
		html = "<center>"+html+"</center>"
		save(p,"C:\\Users\\Niclas\\Development\\PA2\\Tool_Niclas_23.06.2022 (1)\\processed\\SAP_Test_Data_BKPF_Table_for_automation.txt_processed\picture\uniqueSAP_Test_Data_BKPF_Table_for_automation.html")
		return html
if __name__ == "__main__":
	app = SAP_Test_Data_BKPF_Table_for_automation()
