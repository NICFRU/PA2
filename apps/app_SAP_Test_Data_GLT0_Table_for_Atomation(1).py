...
#*** Date:	  23 Oct 2022 13:34:47
#***
#*** Source:	processed\SAP_Test_Data_GLT0_Table_for_Atomation(1).txt_processed
#***
...
class SAP_Test_Data_GLT0_Table_for_Atomation(1)(server.App): 
	link = "C:\\Users\\Niclas\\Development\\PA2\\Tool_Niclas_23.06.2022 (1)\\processed\\SAP_Test_Data_GLT0_Table_for_Atomation(1).txt_processed"
	title = "Overview of the Table SAP_Test_Data_GLT0_Table_for_Atomation(1)"
...
#/******************************************/
	...
	def datahead(self,params):
		df = of.Data(SAP_Test_Data_GLT0_Table_for_Atomation(1).link)
		return df.head(10)

	def description(self, params):
		value = params["values"]
		df = of.overview(SAP_Test_Data_GLT0_Table_for_Atomation(1).link,True)
	...
	def description_plot(self, params):
		...
		save(p,"C:\\Users\\Niclas\\Development\\PA2\\Tool_Niclas_23.06.2022 (1)\\processed\\SAP_Test_Data_GLT0_Table_for_Atomation(1).txt_processed\picture\description_plot_SAP_Test_Data_GLT0_Table_for_Atomation(1).html")
		return html

	def unique(self, params):
		value = params["values"]
		test=copy.copy(value)
		df_string = of.data_str(SAP_Test_Data_GLT0_Table_for_Atomation(1).link)
		...
		html = "<center>"+html+"</center>"
		save(p,"C:\\Users\\Niclas\\Development\\PA2\\Tool_Niclas_23.06.2022 (1)\\processed\\SAP_Test_Data_GLT0_Table_for_Atomation(1).txt_processed\picture\uniqueSAP_Test_Data_GLT0_Table_for_Atomation(1).html")
		return html
if __name__ == "__main__":
	app = SAP_Test_Data_GLT0_Table_for_Atomation(1)()
